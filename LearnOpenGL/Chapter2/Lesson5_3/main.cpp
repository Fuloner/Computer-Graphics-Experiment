...
int main()
{
    ...
    unsigned int specularMap; //镜面反射贴图
    ...
    cubeShader.use();
    cubeShader.setInt("material.diffuse", 0); //手动设置纹理单元
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        cubeShader.setVec3("light.position", myCamera.Position);
        cubeShader.setVec3("light.direction", myCamera.Front);
