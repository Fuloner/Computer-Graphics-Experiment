...
int main()
{
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        view = glm::translate(view, glm::vec3(0.0f, 0.0f, -5.0f)); //注意 我们将矩阵向我们要进行移动场景的反方向移动。
        //view = glm::rotate(view, (float)glfwGetTime() * glm::radians(10.0f), glm::vec3(0.0f, 1.0f, 0.0f)); //绕y轴旋转
